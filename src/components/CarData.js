...
import vm_vento from "../images/cars-big/vw_vento.jpg";
...
export const CAR_DATA = [
  ...
  [
    {
      name: "Maruti Suzuki Brezza White",
      price: "2800",
      img: brezza_white,
      model: "Brezza",
      mark: "Maruti Suzuki",
